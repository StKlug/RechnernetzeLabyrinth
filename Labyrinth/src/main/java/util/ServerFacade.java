...
public final class ServerFacade
{
     ...
     */
    public static BoardType applyMessageToBoard(BoardType oldBoard, MoveMessageType moveMessageType, int id)
    {
    ...
    public static BoardType applyShiftToBoard(BoardType oldBoard, CardType shiftCard, PositionType shiftPosition)
    {
        Board board = new Board(oldBoard);
    ...
    public static ImmutableSet<PositionType> computeReachablePositions(BoardType boardType, PositionType currentPosition)
    {
