 ...
 * <p>
 * Higher level representation in this case means mapping a state of the game to an int. One could also interpret such a
 * Feature as a norm.
 * <p>
 * The state of the game analyzed by a Feature might be either the current state or a hypothetical future state (the
 * implementation of this interface shouldn't have any knowledge about which).
 * 
