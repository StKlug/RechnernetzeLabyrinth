...
public final class ReconfigurableClientConfig extends AbstractModule
{
    ...
    public ReconfigurableClientConfig(Evaluator evaluator, BlockingQueue<MazeCom> serverToClientQueue, BlockingQueue<MazeCom> clientToServerQueue)
    {
    ...
    protected void configure()
    {
        ...
        {}).annotatedWith(Names.named("serverToClient")).toInstance(serverToClientQueue);
        bind(new TypeLiteral<BlockingQueue<MazeCom>>()
        {}).annotatedWith(Names.named("clientToServer")).toInstance(clientToServerQueue);
