...
public final class ReconfigurableClient
{
    ...
    {
        Evaluator delegatingEvaluator = (awaitMoveMessageType, possibleBoardTypes, currentID) -> delegate.findBest(awaitMoveMessageType, possibleBoardTypes, currentID);
        Module guiceConfig = new ReconfigurableClientConfig(delegatingEvaluator, inputQueue, outputQueue);
