 ...
 * features).
 * <p>
 * Furthermore this class allows gradual evolutionary improvement by combining the {@link #copy} and {@link #evolve}
 * methods.
 * 
...
public final class EvolvableFeatureEvaluator implements Evaluator
{
     ...
     * 
     * @param stepSize
     *            the amount that each weight should change in either positive or negative
     *            direction
     */
    ...
    private int linearCombination(AwaitMoveMessageType awaitMoveMessageType, BoardType boardType, CurrentID currentID)
    {
